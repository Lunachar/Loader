    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            if (_input.move != Vector2.zero)
            {
                ...
                if (Grounded && stepTimer <= 0f)
                {
                    audioManager.PlaySound(audioManager.step);
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            if (CinemachineCameraTarget != null)
            {
                ...
                Gizmos.DrawRay(CinemachineCameraTarget.transform.position, direction * 5f); // 5 units long ray
            }
        }
    }
}